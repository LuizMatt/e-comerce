  ...
  return (
    <section className="hero">
      <div className="hero-content">
        ...
        <p>
          Soluções em ferramentas para o dia a dia, profissionais e indústrias.
          Chaves, furadeiras, kits completos e acessórios de qualidade para
          todos os níveis de uso. Atendimento rápido e produtos que facilitam
          sua rotina.
        </p>
      </div>
